 ...
 * @Date	 2019年2月21日 	 
 */
public class ScanTableResult2OrcJobNew extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		ScanTableResult2OrcNew orc = new ScanTableResult2OrcNew();
		//设置conf对象，只设置一次就行
		orc.setConf(conf);
...
//		运行参数：-Dtask.id=0222 -Dtask.base.dir=/tmp/hbase -Dhbase.zookeeper.quorum=nn1.hadoop:2181,nn2.hadoop:2181,s1.hadoop:2181
		ToolRunner.run(new ScanTableResult2OrcJobNew(), args);
	}
